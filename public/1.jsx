...
const AccordionSection = ({ title, icon, children, defaultOpen = false, accentColor = '#C9A86C' }) => {
  const [isOpen, setIsOpen] = useState(defaultOpen);

  return (
    <div className="accordion-section" style={{ '--accent': accentColor }}>
...
const ComplicationCard = ({ title, description, treatment, severity = 'normal' }) => (
...
const MotivaFeatureCard = ({ number, title, children }) => (
...
export default function BreastSurgeryGuide() {
  ...
  return (
    <div className="surgery-guide">
            ...
            <div className="position-guide">
              <div className="position-visual">
                <div className="position-item">
                  <div className="position-icon yusuha">
                    <span>유선 하</span>
                  </div>
                  <p>유선조직 아래</p>
                </div>
                ...
                <div className="position-item">
                  <div className="position-icon geunmak">
                    <span>근막 하</span>
                  </div>
                  <p>대흉근막 아래</p>
                </div>
                <div className="position-arrow">→</div>
                <div className="position-item">
                  <div className="position-icon dual">
                    <span>이중평면</span>
                  </div>
                  <p>대흉근 위·아래 혼합</p>
                </div>
            ...
            <div className="cta-content">
              ...
              <div className="cta-info">
                ...
                <div className="info-item">
                  ...
                  <div>
                    <strong>위치</strong>
                    <span>서울특별시 강남구 도산대로 318 SB타워 6층</span>
                  </div>
                </div>
              </div>
              <a href="https://blog.naver.com/umnagumo" target="_blank" rel="noopener noreferrer" className="cta-button">
                네이버 블로그 바로가기
              </a>
            </div>
          </section>
      ...
      <style jsx>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Noto+Sans+KR:wght@300;400;500;600;700&display=swap');
        ...
        .main-content {
          position: relative;
          background: linear-gradient(180deg, #0D0D0F 0%, #121215 100%);
        }
        ...
        .position-icon.yusuha {
          background: rgba(158, 158, 158, 0.1);
          border-color: rgba(158, 158, 158, 0.3);
          color: #9E9E9E;
        }

        .position-icon.geunmak {
        ...
        .cta-section {
          margin-top: 60px;
          padding: 48px;
          background: linear-gradient(145deg, rgba(201, 168, 108, 0.08) 0%, rgba(201, 168, 108, 0.02) 100%);

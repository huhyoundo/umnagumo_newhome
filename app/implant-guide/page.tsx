      ...
      <main className="pt-[70px] md:pt-0">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="max-w-[1200px] mx-auto px-6 lg:px-16 w-full">
              <div className="max-w-[600px]">
                ...
                <h1 className="text-[28px] md:text-[36px] lg:text-[44px] font-semibold text-white mb-6 tracking-[-0.02em] leading-tight">
                  가슴의 본질을 결정하는<br />
                  보형물 선택
                </h1>
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th className="py-4 px-4">
                      <div className="flex justify-center">
                        <Image
                          src="/보형물 가이드 페이지 사진/멘토엑스트라무스.png"
                          alt="멘토 엑스트라무스"
                          width={120}
                          height={80}
                          className="object-contain"
                  ...
                  <tr className="border-b-2 border-[#8B7355]">
                    <th className="py-5 px-4 text-left text-[13px] md:text-[14px] font-semibold text-gray-700 w-[120px]"></th>
                    <th className="py-5 px-4 text-center text-[13px] md:text-[14px] font-semibold text-gray-800">
                      모티바<br />
                      <span className="font-normal text-gray-500">(Motiva)</span>
                    </th>
                    <th className="py-5 px-4 text-center text-[13px] md:text-[14px] font-semibold text-gray-800">
                      멘토 부스트<br />
                      <span className="font-normal text-gray-500">(Mentor BOOST)</span>
                    </th>
                    <th className="py-5 px-4 text-center text-[13px] md:text-[14px] font-semibold text-gray-800">
                      멘토 엑스트라무스<br />
                      <span className="font-normal text-gray-500">(Mentor Xtra)</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {implantComparison.map((row, index) => (
                    <tr key={index} className="border-b border-gray-200">
                      <td className="py-4 px-4 text-[12px] md:text-[13px] font-medium text-gray-700 bg-gray-50 whitespace-nowrap">{row.label}</td>
                      <td className="py-4 px-4 text-[11px] md:text-[12px] text-gray-600 text-center whitespace-pre-line">{row.motiva}</td>
                      <td className="py-4 px-4 text-[11px] md:text-[12px] text-gray-600 text-center whitespace-pre-line">{row.boost}</td>
                      <td className="py-4 px-4 text-[11px] md:text-[12px] text-gray-600 text-center whitespace-pre-line">{row.xtra}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
        ...
        <section className="py-10 md:py-14 bg-white">
          <div className="max-w-[900px] mx-auto px-6 lg:px-10">
            <div className="border border-gray-200 rounded-sm p-8 md:p-10">
              <div className="grid md:grid-cols-[180px_1fr] gap-8 items-start">
                ...
                <div>
                  <h2 className="text-[18px] md:text-[20px] font-semibold text-[#2a2a2a] mb-4">
                    모티바(Motiva)
                  </h2>
                  <p className="text-[12px] md:text-[13px] text-gray-600 leading-relaxed mb-3">
          ...
          <div className="max-w-[900px] mx-auto px-6 lg:px-10">
            <div className="border border-gray-200 rounded-sm p-8 md:p-10">
              <div className="grid md:grid-cols-[180px_1fr] gap-8 items-start">
                ...
                <div>
                  <h2 className="text-[18px] md:text-[20px] font-semibold text-[#2a2a2a] mb-1">
                    멘토 부스트
                  </h2>
                  <p className="text-[14px] text-gray-500 mb-4">(Mentor MemoryGel BOOST)</p>
                  <p className="text-[12px] md:text-[13px] text-gray-600 leading-relaxed mb-3">
            ...
            <div className="border border-gray-200 rounded-sm p-8 md:p-10">
              <div className="grid md:grid-cols-[180px_1fr] gap-8 items-start">
                ...
                <div>
                  ...
                  <p className="text-[14px] text-gray-500 mb-4">(Mentor MemoryGel Xtra)</p>
                  <p className="text-[12px] md:text-[13px] text-gray-600 leading-relaxed mb-3">
        ...
        <section className="py-16 md:py-24 bg-[#f8f6f3]">
          <div className="max-w-[1000px] mx-auto px-6 lg:px-10">
            ...
            <div className="flex items-center justify-center gap-4 md:gap-8">
              {/* Ultrasound */}
              <div className="text-center flex-1 max-w-[320px]">
                ...
                <h3 className="text-[13px] md:text-[14px] font-semibold text-[#2a2a2a] mb-2">보형물 삽입 후에도</h3>
              ...
              <div className="text-center flex-1 max-w-[320px]">
                ...
                <h3 className="text-[13px] md:text-[14px] font-semibold text-[#2a2a2a] mb-2">보형물은 유방암 검사에</h3>
                <p className="text-[11px] md:text-[12px] text-gray-500 leading-relaxed">
                  장애가 되지 않으며<br />
              ...
              <div className="text-center flex-1 max-w-[320px]">
                ...
                <h3 className="text-[13px] md:text-[14px] font-semibold text-[#2a2a2a] mb-2">파손 여부는 초음파로 확인하며</h3>
                <p className="text-[11px] md:text-[12px] text-gray-500 leading-relaxed">

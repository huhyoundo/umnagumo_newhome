      ...
      faqs={[
        {
          ...
          answer: '일반적으로 1차 수술 후 6개월~1년 이후가 안정적이며, 구축·파손 등 문제가 있는 경우는 더 빨리 가능할 수 있습니다.',
        },
        {
          question: '재수술 전 준비는 어떻게 해야 하나요?',
          answer: '보형물 상태 확인, 금연 2주, 출혈 위험 약물 중단, 기존 수술 정보 제공이 필요합니다.',
        },
        {
          question: '회복기간은 얼마나 걸리나요?',
          answer: '대부분 3~5일 내 일상 복귀, 운동은 4~6주 후 가능합니다.',
        },
        {
        ...
        },
        {
          ...
          answer: '초기 마사지 금지, 정기 내원 체크, 금연, 금주 등 염증 유발 요인 회피가 중요합니다.',
        },
      ]}
    />
  );
